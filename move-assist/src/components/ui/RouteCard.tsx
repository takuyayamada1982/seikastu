    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="mt-4 grid grid-cols-3 gap-2 text-center">
        <div className="rounded-xl bg-slate-50 p-2">
          ...
          <p className="mt-1 text-sm font-semibold text-slate-900">{route.durationText}</p>
        </div>
        <div className="rounded-xl bg-slate-50 p-2">
          <p className="text-[11px] text-slate-500">金額目安</p>
          <p className="mt-1 text-sm font-semibold text-slate-900">{route.costText}</p>
        </div>
        <div className="rounded-xl bg-slate-50 p-2">
          <p className="text-[11px] text-slate-500">徒歩負荷</p>
          <p className="mt-1 text-sm font-semibold text-slate-900">{route.walkingLevel}</p>
        </div>
      </div>
